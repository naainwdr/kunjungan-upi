        ...
        <form method="GET" action="{{ route('petugas.presensi.index') }}">
            <div class="flex flex-wrap items-center gap-3">
                ...
                <div class="flex gap-1 bg-gray-100 rounded-lg p-1">
                    ...
                    <a href="{{ route('petugas.presensi.index', array_merge(request()->query(), ['filter' => $val])) }}"
                ...
                <div class="flex items-center gap-2">
                    ...
                    @if(request('tgl'))
                    <a href="{{ route('petugas.presensi.index', ['filter' => $filter]) }}" class="text-gray-400 text-xs hover:underline">Reset</a>
                    @endif
                </div>
            </div>
        </form>
            ...
            <table class="w-full text-sm border-collapse">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        <td class="px-4 py-3">
                            <span class="font-mono text-xs text-[#800000] font-semibold">
