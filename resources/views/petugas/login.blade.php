...
<body class="bg-gray-100 min-h-screen flex items-center justify-center px-4">
    <div class="w-full max-w-sm">
        ...
        <div class="text-center mb-6">
            <div class="w-16 h-16 bg-upi-red text-white rounded-2xl flex items-center justify-center text-2xl mx-auto mb-3 shadow-md">
                📋
            </div>
        ...
        {{-- Badge Info --}}
        <div class="bg-amber-50 border border-amber-200 rounded-xl p-3 mb-4 flex items-center gap-2 text-sm text-amber-700">
            <span class="text-base">🔒</span>
            <span>Halaman ini khusus untuk <strong>Petugas Presensi</strong>. Jika Anda Admin, gunakan <a href="{{ route('admin.login') }}" class="underline font-semibold">login Admin</a>.</span>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
            ...
            <form method="POST" action="{{ route('petugas.login.post') }}" id="form-login-petugas">
                @csrf
                <div class="mb-4">
                    ...
                    <input type="email" id="email" name="email"
                        ...
                        value="{{ old('email') }}" placeholder="petugas@upi.edu" required autofocus>
                </div>
                <div class="mb-5">
                ...
                <button type="submit" id="btn-login-petugas"
                    class="w-full bg-upi-red text-white py-2.5 rounded-lg font-bold hover:bg-upi-dark transition-colors">
